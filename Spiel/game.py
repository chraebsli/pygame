...
random_number = random.randint(
    0, 2)  # Random Hintergrundfarbe für Loginscreen, Wände oder Playerpath
play_music = True
switch_music = False
print("please select the game window, the game started")
main_path = os.path.dirname(__file__)
path = str(os.path.join(main_path,
                        "resources")) + "/"  # The resource folder path
...
coin1_rect = pygame.Rect(coin_coords_x[0], coin_coords_y[0], 44,
                         44)  # x, y, -x, -y
...
# images
background_titlescreen = pygame.image.load(
    path + "images/titlescreen/background_titlescreen.png")
background_game = pygame.image.load(path + "images/gamescreen/background.png")
background_skinscreen = pygame.image.load(path +
                                          "images/skinsscreen/background.png")
...
leaderboard_button = pygame.image.load(
    path + "images/titlescreen/button_leaderboard.png")
...
message_skin_one = pygame.image.load(path +
                                     "images/skinsscreen/Message_One.png")
...
button_highscore = pygame.image.load(path +
                                     "images/titlescreen/button_highscore.png")
...
settings_manuels = pygame.image.load(path +
                                     "images/manuels/settings_banner.png")
settings_background = pygame.image.load(path +
                                        "images/settings/settings_img.png")
settings_demo = pygame.image.load(path + "images/settings/settings_demo.png")
settings_demo_vertical = pygame.image.load(
    path + "images/settings/settings_vertical_line.png")
settings_demo_horizontal = pygame.image.load(
    path + "images/settings/settings_horizontal_line.png")
pygame.init()
screen = pygame.display.set_mode((display_xy))

# audio
# AdhesiveWombat - Night Shade
normal_background = path + "audio/background/music.mp3"
...
data = {
    ...
    "settings_demo_vertical": settings_demo_vertical,
    "settings_demo_horizontal": settings_demo_horizontal,
}
data_1 = {
    "background_titlescreen": background_titlescreen,
    "play_button": play_button,
    "buttons_titlescreen_xy": buttons_titlescreen_xy,
    "leaderboard_button": leaderboard_button,
    "play_button_rect": play_button_rect,
    "quit_button": quit_button,
    "skin_button": skin_button,
    "skin_button_rect": skin_button_rect,
    "quit_button_rect": quit_button_rect,
    "button_highscore": button_highscore,
    "leaderboard_button_rect": leaderboard_button_rect,
    "howto_button_rect": howto_button_rect,
    "howto_button": howto_button,
}
data_2 = {
    ...
    "wall_coords_xy": wall_coords_xy,
    "walls_rect": walls_rect,
    "coin_coords": coin_coords_xy,
    "coins_rect": coins_rect,
}
data_3 = {
    "background_skinscreen": background_skinscreen,
    "skins_skinscreen": skins_skinscreen,
...
while running is True:
    ...
    if screenmode == "gamescreen" or sm == "gamescreen":
        ...
        if switch_music is False:
            ...
            switch_music = True
            play_music = True
        sm = gamescreens.gamescreen(data=data,
                                    data_2=data_2,
                                    remo_list=remo_list,
