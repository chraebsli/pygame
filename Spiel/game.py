...
status=0
block_coords=[]
wall1_rect=[wall_coords_x[0],wall_coords_y[0],47,192] # x, y, -x, -y
wall2_rect=[wall_coords_x[1],wall_coords_y[1],47,242]
wall3_rect=[wall_coords_x[2],wall_coords_y[2],47,291]
wall4_rect=[wall_coords_x[3],wall_coords_y[3],192,48]
wall5_rect=[wall_coords_x[4],wall_coords_y[4],240,48]
wall6_rect=[wall_coords_x[5],wall_coords_y[5],290,48]
wall7_rect=[wall_coords_x[6],wall_coords_y[6],47,192] 
wall8_rect=[wall_coords_x[7],wall_coords_y[7],47,242]
wall9_rect=[wall_coords_x[8],wall_coords_y[8],47,291]
wall10_rect=[wall_coords_x[9],wall_coords_y[9],192,48]
wall11_rect=[wall_coords_x[10],wall_coords_y[10],241,48]
wall12_rect=[wall_coords_x[11],wall_coords_y[11],290,48]
