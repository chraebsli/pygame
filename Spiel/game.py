...
t1 = gamefunctions.start_timer() # timerstart
remo_list = []
sound = 'on' # playsound standard
random_number = random.randint(0,2) # random bg color on loginscreen
play_music = True
switch_music = False
...
# create pygame.Rect for walls and coins
...
# datapack for parameters
# data: universal, data_1: titlescreen, data_2: gamescreen,data_3: skinscreen
